package com.duan.android.jpushdemo.utils;
...
public class PermissionUtils {
    ...
    private void startPermissionActivity() {
        ...
        PermissionUtils.PermissionActivity.start(AppUtils.getApp());
    }
    ...
    public static class PermissionActivity extends Activity {
        ...
        public static void start(final Context context) {
            Intent starter = new Intent(context, PermissionUtils.PermissionActivity.class);
